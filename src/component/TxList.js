export default function TxList({ txs, setTxs }) {
  return (
      ...
      <div className="m-4 pt-2 px-6 pb-6 w-full mx-auto rounded-xl ">
        <div class="p-4 rounded-lg border  shadow-md sm:p-6 lg:p-8 ">
          <div className="p-4">
              <h1 className="text-xl pb-5 font-semibold text-black text-center">
                Recent transactions
              </h1>
              <hr className="pb-5"/>
              {txs.map((item) => (
